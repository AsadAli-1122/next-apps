      ...
      <div className="grid sm:grid-cols-12 bg-white rounded-2xl shadow overflow-hidden max-w-4xl">
        ...
        <div className="sm:col-span-7 space-y-5 sm:space-y-3 p-10 pb-6 sm:pb-10 relative">
          <h1 className="font-semibold text-2xl text-APC-dark-grayish-blue">
            Shift the overall look and feel by adding these wounderful touches to furniture in your home
          </h1>
          <p className="text-sm text-APC-desaturated-blue">
          Ever been in a room and felt like somrthing was missing? <br />
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="ml-auto w-8 h-8 rounded-full bg-APC-light-grayish-blue flex justify-center items-center cursor-pointer hover:bg-APC-dark-grayish-blue active:bg-APC-dark-grayish-blue text-APC-dark-grayish-blue hover:text-APC-light-grayish-blue active:text-APC-light-grayish-blue duration-200 ease-in-out group">
              <Share width={15} height={15} strokeWidth={2.5} className="" />
              <div className="absolute right-0 left-0 bottom-0 h-16 sm:h-20 bg-APC-dark-grayish-blue px-10 flex items-center space-x-4 translate-y-full group-hover:translate-y-0 duration-300 ease-in-out cursor-auto">
                ...
                <div className="ml-auto w-6 h-6 rounded-full bg-APC-desaturated-blue text-APC-light-grayish-blue flex justify-center items-center cursor-pointer hover:scale-125 duration-200 ease-in-out ">
                <Share width={15} height={15} strokeWidth={2.5} className="" />
                </div>
                <div>
                </div>
